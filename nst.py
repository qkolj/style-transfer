...
parser.add_argument('-i', '--input-type', choices=['content', 'noise'], default='content', help='Use either content image or white noise image as input')
parser.add_argument('--use-rgb', action='store_true', help='Use RBG images as input for VGG19 model instead of BGR images')
parser.add_argument('-d', '--dimensions', type=int, nargs=2, default=(512, 683), metavar=('H', 'W'), help='Dimensions of the output image, HxW')
...
parser.add_argument('--num-iters', type=int, default=500, help='Number of optimization iterations')
parser.add_argument('--print-every', metavar='N', type=int, default=50, help='Print current loss on every N iterations')
parser.add_argument('--alpha', type=float, default=1.e0, help='Style loss weight parameter')
parser.add_argument('--beta', type=float, default=1.e3, help='Content loss weight parameter')
